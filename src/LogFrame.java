		...
		public class LogFrame extends JFrame {
			...
			private JScrollPane createResultsTable(ArrayList <String> Contacts){
				resultsTable = new JTable();
				myContactsTableModel = new ContactTableModel(Contacts);
				resultsTable.setModel(myContactsTableModel);
